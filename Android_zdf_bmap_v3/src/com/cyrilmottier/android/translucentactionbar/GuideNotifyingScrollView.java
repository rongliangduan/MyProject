 ...
 */
public class GuideNotifyingScrollView extends ScrollView {
	...
	public GuideNotifyingScrollView(Context context) {
		super(context);
	}

	public GuideNotifyingScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public GuideNotifyingScrollView(Context context, AttributeSet attrs, int defStyle) {
	...
	private static final String TAG = GuideNotifyingScrollView.class.getSimpleName();
