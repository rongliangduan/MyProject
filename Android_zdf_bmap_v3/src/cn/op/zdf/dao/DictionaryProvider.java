...
public class DictionaryProvider extends ContentProvider {
	...
	public static String AUTHORITY = "cn.op.zdf.dao.DictionaryProvider";
	...
	private Cursor getWord(Uri uri) {
		...
		String[] columns = new String[] { DictionaryDatabase.KEY_WORD,
				DictionaryDatabase.KEY_DEFINITION, MyDbHelper.COLUMN_HOTEL_ID,
				MyDbHelper.COLUMN_NAME, MyDbHelper.COLUMN_ADDR,
				MyDbHelper.COLUMN_BRAND_NAME, MyDbHelper.COLUMN_LAT,
				MyDbHelper.COLUMN_LNG, MyDbHelper.COLUMN_BRAND_ID,
				MyDbHelper.COLUMN_LOGO, MyDbHelper.COLUMN_TEL };
